"""
main2.py - Interfaz de usuario del Sistema de Gestión Bibliotecaria

Este módulo implementa la capa de presentación del sistema usando
ventanas de diálogo de tkinter (messagebox / simpledialog).

Funcionalidades principales:
  - Autenticación de usuarios con límite de 3 intentos
  - Gestión de usuarios, sedes y bibliotecas (solo administradores)
  - Selección de sede activa para trabajar en su biblioteca
  - Gestión de clientes, categorías y materiales bibliográficos
  - Gestión de reservas y préstamos (con actualización automática
    del estado del material: disponible → reservado / prestado)
  - Gestión de sanciones (veta automáticamente al cliente sancionado)

Punto de entrada: función main() → instancia SistemaGestion y llama a ejecutar()

Dependencias: crud/, entities/, database/, auth/ del mismo proyecto
"""
